...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingReceiver = new ChargingBroadcastReceiver();        // and an IntentFilter

        mChargingIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mChargingIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);        // and Intent.ACTION_POWER_DISCONNECTED. This sets up an intent filter which will trigger
